...
void* malloc(size_t size) {
    ...
    log_message("malloc address: %p, size: %zu bytes, duration: %ld ns\n", result, size, end_time_ns - start_time_ns);
    return result;
}
...
void* calloc(size_t nmemb, size_t size) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("calloc address: %p, nmemb: %zu, size: %zu bytes, duration: %ld ns\n", result, nmemb, size, end_time_ns - start_time_ns);
    return result;
}
...
void* realloc(void* ptr, size_t size) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("realloc address: %p, new size: %zu bytes, duration: %ld ns\n", result, size, end_time_ns - start_time_ns);
    return result;
}
...
void free(void* ptr) {
    ...
    original_free(ptr);
    long end_time_ns = get_current_time_ns();
    log_message("free address: %p, duration: %ld ns\n", ptr, end_time_ns - start_time_ns);
}
...
void* memset(void* s, int c, size_t n) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("memset address: %p, value: %d, size: %zu bytes, duration: %ld ns\n", s, c, n, end_time_ns - start_time_ns);
    return result;
}
...
void* memcpy(void* dest, const void* src, size_t n) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("memcpy from: %p to: %p, size: %zu bytes, duration: %ld ns\n", src, dest, n, end_time_ns - start_time_ns);
    return result;
}
...
void* memmove(void* dest, const void* src, size_t n) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("memmove from: %p to: %p, size: %zu bytes, duration: %ld ns\n", src, dest, n, end_time_ns - start_time_ns);
    return result;
}
...
int memcmp(const void* s1, const void* s2, size_t n) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("memcmp from: %p to: %p, size: %zu bytes, result: %d, duration: %ld ns\n", s1, s2, n, result, end_time_ns - start_time_ns);
    return result;
}
...
void* mmap(void* addr, size_t length, int prot, int flags, int fd, off_t offset) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("mmap address: %p, size: %zu bytes, duration: %ld ns\n", result, length, end_time_ns - start_time_ns);
    return result;
}
...
int munmap(void* addr, size_t length) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("munmap address: %p, size: %zu bytes, duration: %ld ns\n", addr, length, end_time_ns - start_time_ns);
    return result;
}
...
int mprotect(void* addr, size_t len, int prot) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("mprotect address: %p, size: %zu bytes, prot: %d, duration: %ld ns\n", addr, len, prot, end_time_ns - start_time_ns);
    return result;
}
...
int mlock(const void* addr, size_t len) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("mlock address: %p, size: %zu bytes, duration: %ld ns\n", addr, len, end_time_ns - start_time_ns);
    return result;
}
...
int munlock(const void* addr, size_t len) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("munlock address: %p, size: %zu bytes, duration: %ld ns\n", addr, len, end_time_ns - start_time_ns);
    return result;
}
...
void bzero(void* s, size_t len) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("bzero address: %p, size: %zu bytes, duration: %ld ns\n", s, len, end_time_ns - start_time_ns);
}
...
void bcopy(const void* src, void* dest, size_t len) {
    ...
    long end_time_ns = get_current_time_ns();
    log_message("bcopy from: %p to: %p, size: %zu bytes, duration: %ld ns\n", src, dest, len, end_time_ns - start_time_ns);
}
